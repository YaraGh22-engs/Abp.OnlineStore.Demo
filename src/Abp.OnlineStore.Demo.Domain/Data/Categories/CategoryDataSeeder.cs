...
namespace Abp.OnlineStore.Demo.Data.Categories
{
    internal class CategoryDataSeeder : IDataSeedContributor, ITransientDependency
    {
        ...
        {
            // condetion for one time seeding
